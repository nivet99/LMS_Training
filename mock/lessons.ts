...
export type MockLesson = {
  ...
  isFree: boolean;
  youtubeUrl?: string; // YouTube URL ที่ผู้สอนแนบ
    ...
    lessons: [
      {
        ...
        duration: 720,
        isFree: true,
        youtubeUrl: "https://www.youtube.com/watch?v=SRec90j6lTY",
      ...
      },
      {
        ...
        duration: 840,
        isFree: true,
        youtubeUrl: "https://www.youtube.com/watch?v=RlQEoJaLQRA",
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: 1800,
        isFree: false,
        youtubeUrl: "https://www.youtube.com/watch?v=D4NyQ5ZsLs8",
    ...
    lessons: [
      {
        ...
        duration: 900,
        isFree: true,
        youtubeUrl: "https://www.youtube.com/watch?v=bixR-KIJKYM",
    ...
    lessons: [
      {
        ...
        duration: 1080,
        isFree: false,
        youtubeUrl: "https://www.youtube.com/watch?v=BNHR6IQJGZs",
      ...
      },
      {
        ...
        duration: 1440,
        isFree: false,
        youtubeUrl: "https://www.youtube.com/watch?v=MYE6T_gd7H0",
